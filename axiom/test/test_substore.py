...
class SubStoreTest(unittest.TestCase):
    ...
    def test_createNewStringPath(self):
        ...
        """
        s = Store()
        e = self.assertRaises(ValueError, SubStore.createNew, s, 'notasequence')
        self.assertEqual(e.args[0], "Received 'notasequence' instead of a sequence")
...
class SubStoreStartupSemantics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ssitem = ssitem = SubStore.createNew(topdb, ["dontstartme", "really"])
        self.ss = ssitem.open()
